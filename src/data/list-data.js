let listData = {
  lists : [
    ...
    },
    {
      title : "Helmet Skins",
      list: [
        { title: "Ash Carabid Helmet", acquisition: "Tennogen (Steam Store)" },
        { title: "Ash Locust Helmet", acquisition: "Nightwave" },
        { title: "Ash Scorpion Helmet", acquisition: "Nightwave" },
        { title: "Atlas Arhat Helmet", acquisition: "Tennogen (Steam Store)" },
        { title: "Atlas Shikoro Helmet", acquisition: "Nightwave" },
        { title: "Atlas Tartarus Helmet", acquisition: "Nightwave" },
        { title: "Atlas Telamon Helmet", acquisition: "Tennogen (Steam Store)" },
        { title: "Banshee Chorus Helmet", acquisition: "Nightwave" },
        { title: "Banshee Dominia Helmet", acquisition: "Tennogen (Steam Store)" },
        { title: "Banshee Echo Helmet", acquisition: "Tennogen (Steam Store)" },
        { title: "Banshee Reverb Helmet", acquisition: "Nightwave" },
        { title: "Baruuk Meroe Helmet", acquisition: "Nightwave" },
        { title: "Chroma Amaru Helmet", acquisition: "Nightwave" },
        { title: "Chroma Drac Helmet", acquisition: "Nightwave" },
        { title: "Chroma Kaiju Helmet", acquisition: "Tennogen (Steam Store)" },
        { title: "Chroma Tarrasque Helmet", acquisition: "Tennogen (Steam Store)" },
        { title: "Ember Backdraft Helmet", acquisition: "Nightwave" },
        { title: "Ember Phoenix Helmet", acquisition: "Nightwave" },
        { title: "Equinox Clisthert Helmet", acquisition: "Nightwave" },
        { title: "Equinox Solstice Helmet", acquisition: "Nightwave" },
        { title: "Excalibur Arturius Helmet", acquisition: "Tennogen (Steam Store)" },
        { title: "Excalibur Avalon Helmet", acquisition: "Nightwave" },
        { title: "Excalibur Isurus Helmet", acquisition: "Tennogen (Steam Store)" },
        { title: "Excalibur Mordred Helmet", acquisition: "Nightwave" },
        { title: "Excalibur Ogrant Helmet", acquisition: "Tennogen (Steam Store)" },
        { title: "Excalibur Pendragon Helmet", acquisition: "Nightwave" },
        { title: "Excalibur Umbra Beast Helmet", acquisition: "Unobtainable", unobtainable: true},
        { title: "Excalibur Umbra Sunder Helmet", acquisition: "The Sacrifice" },
      ],
    },
  ]
};
