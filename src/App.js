    ...
    return (
      <div className="App">
        ...
        <p className="App-intro">
          ...
          Major thanks to github users <a href="https://github.com/devzspy">DevzSpy</a>, <a href="https://github.com/RylaiSlyfe">RylaiSlyfe</a>, <a href="https://github.com/Jakub-Michalak">Jakub-Michalak</a>, and <a href="https://github.com/pgbconfirmit">pgbconfirmit</a> for helping to keep the list up to date!<br />
        ...
        <BrowserCompatability>
          <div>
            <div className="container">
              <div className="toggleButton"><input type="checkbox" checked={this.state.hideMaxRank} onChange={this.toggleHideMaxRank}/>Hide Max Rank/Owned Items</div>
              {subLists}
            </div>
          </div>
        </BrowserCompatability>
